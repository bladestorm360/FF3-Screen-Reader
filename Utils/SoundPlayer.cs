...
namespace FFIII_ScreenReader.Utils
{
    ...
    public static class SoundPlayer
    {
        ...
        public static void PlayWallBump()
        {
            ...
            if (len <= 0) return;
            float gain = FFIII_ScreenReader.Core.PreferencesManager.WallBumpVolume / 50.0f;
        ...
        public static void PlayFootstep()
        {
            ...
            if (len <= 0) return;
            float gain = FFIII_ScreenReader.Core.PreferencesManager.FootstepVolume / 50.0f;
        ...
        /// EXP bar animation). Volume is baked into the buffer, then scaled by the user's
        /// ExpCounterVolume via per-stream gain. The loop is kept fed by TopUpExpCounter,
        /// called from the monitor coroutine each tick; StopExpCounter clears it.
        /// </summary>
        public static void PlayExpCounter()
        {
            ...
            int volume = FFIII_ScreenReader.Core.PreferencesManager.ExpCounterVolume;
