...
namespace FFIII_ScreenReader.Core
{
    ...
    internal static class TextInputWindow
    {
        ...
        public static void Open(string promptText, string initialText, Action<string> onConfirm, Action onCancel = null)
        {
            ...
            WindowsFocusHelper.StealFocus("FFIII_TextInput");
        ...
        public static bool HandleInput()
        {
            ...
            if (WindowsFocusHelper.IsKeyDown(WindowsFocusHelper.VK_BACK))
            {
                if (cursorPosition > 0)
                {
                    ...
                    cursorPosition--;
                    FFIII_ScreenReaderMod.SpeakText(GetCharacterName(deletedChar), interrupt: true);
                }
                return true;
            }
            ...
            if (WindowsFocusHelper.IsKeyDown(WindowsFocusHelper.VK_LEFT))
            {
                ...
                {
                    cursorPosition--;
                    FFIII_ScreenReaderMod.SpeakText(GetCharacterName(inputBuffer[cursorPosition]), interrupt: true);
                }
                return true;
            }
            ...
            if (WindowsFocusHelper.IsKeyDown(WindowsFocusHelper.VK_HOME))
            {
                ...
                {
                    FFIII_ScreenReaderMod.SpeakText(GetCharacterName(inputBuffer[0]), interrupt: true);
                }
                return true;
            }
